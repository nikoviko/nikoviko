...
* [**Calculadora Fórmula de Bhaskara**](https://github.com/nikoviko/calculadora_bhaskara): Uma calculadora que calcula as raízes da equação, retornando também caso não possua raízes reais.
* [**Grafos**](https://github.com/nikoviko/graph-thing): Projeto para trabalhar com grafos, sendo possível criar vértices, ligar eles com arestas, e mostrar tudo de um jeito simples.
* [**Calculadora de Troco**](https://github.com/nikoviko/calculadora-sorveteria.io): O usuário informa a quantidade de milkshakes vendidos e o valor pago pelo cliente, a aplicação calcula o total da compra e retorna o troco automaticamente.
...
![Minhas Estatísticas no GitHub](https://github-readme-stats.vercel.app/api?username=nikoviko&show_icons=true&theme=radical)
